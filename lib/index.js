...
var self = module.exports = function(learn, config, dialect) {
    ...
    self.scenario = function(dialect, scope) {
        ...
        _.defaults(scope, { agent:{}, agents: { default: {} },
            targets: {default: { proxy: {} } }, target:{ proxy: {} },
            certificates: { default: {} } } );

        scope.targets.default = _.extend( { proxy: {} }, scope.targets.default)
    ...
    self.annotations = function(dialect, annotations, scope) {
        ...
        scope.target = _.extend({ proxy: {} }, scope.targets.default, scope.target, scope.targets[annotations.target]);
